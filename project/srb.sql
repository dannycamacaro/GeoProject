...
CREATE TABLE IF NOT EXISTS `srb`.`routes` (
  ...
  `NAMEROUTES` VARCHAR(100) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  `DESCRIPTION` VARCHAR(400) CHARACTER SET 'utf8' NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `srb`.`routes_has_device`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `srb`.`routes_has_device` ;

CREATE TABLE IF NOT EXISTS `srb`.`routes_has_device` (
  `routes_idROUTES` INT(11) NOT NULL,
  `device_idDEVICE` INT(11) NOT NULL,
  `device_users_idusers` INT NOT NULL,
  `device_users_roles_idroles` INT NOT NULL,
  `device_vehicle_idVEHICLE` INT(11) NOT NULL,
  PRIMARY KEY (`routes_idROUTES`, `device_idDEVICE`, `device_users_idusers`, `device_users_roles_idroles`, `device_vehicle_idVEHICLE`),
  INDEX `fk_routes_has_device_device1_idx` (`device_idDEVICE` ASC, `device_users_idusers` ASC, `device_users_roles_idroles` ASC, `device_vehicle_idVEHICLE` ASC),
  INDEX `fk_routes_has_device_routes1_idx` (`routes_idROUTES` ASC),
  CONSTRAINT `fk_routes_has_device_routes1`
    FOREIGN KEY (`routes_idROUTES`)
    REFERENCES `srb`.`routes` (`idROUTES`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_routes_has_device_device1`
    FOREIGN KEY (`device_idDEVICE` , `device_users_idusers` , `device_users_roles_idroles` , `device_vehicle_idVEHICLE`)
    REFERENCES `srb`.`device` (`idDEVICE` , `users_idusers` , `users_roles_idroles` , `vehicle_idVEHICLE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `srb`.`vehicle_has_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `srb`.`vehicle_has_users` ;

CREATE TABLE IF NOT EXISTS `srb`.`vehicle_has_users` (
  `vehicle_idVEHICLE` INT(11) NOT NULL,
  `users_idusers` INT NOT NULL,
  `users_roles_idroles` INT NOT NULL,
  `users_assignedvehicle_idASSIGNEDVEHICLE` INT(11) NOT NULL,
  `date` DATE NULL,
  PRIMARY KEY (`vehicle_idVEHICLE`, `users_idusers`, `users_roles_idroles`, `users_assignedvehicle_idASSIGNEDVEHICLE`),
  INDEX `fk_vehicle_has_users_users1_idx` (`users_idusers` ASC, `users_roles_idroles` ASC, `users_assignedvehicle_idASSIGNEDVEHICLE` ASC),
  INDEX `fk_vehicle_has_users_vehicle1_idx` (`vehicle_idVEHICLE` ASC),
  CONSTRAINT `fk_vehicle_has_users_vehicle1`
    FOREIGN KEY (`vehicle_idVEHICLE`)
    REFERENCES `srb`.`vehicle` (`idVEHICLE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vehicle_has_users_users1`
    FOREIGN KEY (`users_idusers` , `users_roles_idroles` , `users_assignedvehicle_idASSIGNEDVEHICLE`)
    REFERENCES `srb`.`users` (`idusers` , `roles_idroles` , `assignedvehicle_idASSIGNEDVEHICLE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
